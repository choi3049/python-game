...
# 배경 이미지 불러오기
background = pygame.image.load("/Users/byeongseonchoe/Desktop/崔秉善/코딩/python-game/pygame_basic/back.png")

# 캐릭터 불러오기
character = pygame.image.load("/Users/byeongseonchoe/Desktop/崔秉善/코딩/python-game/pygame_basic/ca.png")
...
# 적 캐릭터
enemy = pygame.image.load("/Users/byeongseonchoe/Desktop/崔秉善/코딩/python-game/pygame_basic/enemy.png")
...
while running:
    dt = clock.tick(60) # 게임 화면의 프레임 수 설정

    # print("fps : " + str(clock.get_fps())) # 프레임 확인가능

    for event in pygame.event.get(): # 어떤 이벤트가 발생하였는가?
        if event.type == pygame.QUIT: # 창이 닫히는 이벤트가 방생하였는가?
    ...
    # screen.fill((0, 0, 255)) 배경색 넣어주기 다른 방법
    ...
    # 타이머 집어넣기
    # 경과 시간 계산
    elapsed_time = (pygame.time.get_ticks() - start_ticks) / 1000 # 경과시간 초단의 변경
